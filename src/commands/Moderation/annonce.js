...
module.exports = {
    ...
    usage: "/annonce [annonce: annonce] (image: lien de votre image)",
    example: "/annonce [annonce: Tadashi !]",
    category: "🔨 Modération",
    ...
    async execute(client, interaction) {
        ...
        if(!channelData1) return Error(interaction, "La configuration de l'annonce n'est pas configurer, merci de faire la commande slash `/config annonce` de Protect !")
